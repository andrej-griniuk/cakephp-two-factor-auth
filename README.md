[![Build Status](https://github.com/andrej-griniuk/cakephp-two-factor-auth/actions/workflows/ci.yml/badge.svg)](https://github.com/andrej-griniuk/cakephp-two-factor-auth/actions/workflows/ci.yml)
